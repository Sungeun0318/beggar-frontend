            ...
            child: Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: const [
                    ChoiceBox(icon: Icons.restaurant, label: '식사'),
                    ChoiceBox(icon: Icons.local_cafe, label: '카페'),
                    ChoiceBox(icon: Icons.palette_outlined, label: '놀거리'),
                    ChoiceBox(icon: Icons.star_border, label: '기타'),
                  ],
                ),
                const SizedBox(height: 38),
